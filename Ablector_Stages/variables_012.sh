...
ARGS="--ufReuse=1 --omit mul:3 --omit sdiv:3 --omit udiv:3"
...
if [ `hostname` = "hal9000" ]; then
    ...
    LOG_DIR_BASE=`pwd`"/logs/Ablector_Stages/stage012/"
    ...
    # Directory for log writing
    LOG_DIR_BASE="/raid/steuber/Logs/Ablector_Stages/stage012/"
    # Binary which should be executed
