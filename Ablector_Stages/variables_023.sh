...
ARGS="--ufReuse=1 --omit mul:1 --omit sdiv:1 --omit udiv:1"
...
if [ `hostname` = "hal9000" ]; then
    ...
    LOG_DIR_BASE=`pwd`"/logs/Ablector_Stages/stage023/"
    ...
    # Directory for log writing
    LOG_DIR_BASE="/raid/steuber/Logs/Ablector_Stages/stage023/"
    # Binary which should be executed
