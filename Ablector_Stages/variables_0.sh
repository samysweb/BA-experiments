...
ARGS="--ufReuse=1 --omit mul:1 --omit mul:2 --omit mul:3 --omit sdiv:1 --omit sdiv:2 --omit sdiv:3 --omit udiv:1 --omit udiv:2 --omit udiv:3"
...
if [ `hostname` = "hal9000" ]; then
    ...
    LOG_DIR_BASE=`pwd`"/logs/Ablector_Stages/stage0/"
    ...
    # Directory for log writing
    LOG_DIR_BASE="/raid/steuber/Logs/Ablector_Stages/stage0/"
    # Binary which should be executed
