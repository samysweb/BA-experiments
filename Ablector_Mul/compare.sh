...
then
    ...
    buildHist Ablector_Mul/segment_aa/2019-06-17T16:50+02:00 MulNode 2
fi
...
then
    ...
    buildHist Ablector_Mul/segment_aa/2019-06-19T22:40+02:00 MulNode 2
fi
...
then
    ...
    buildHist Ablector_Mul/segment_aa/2019-06-24T15:08+02:00 MulNode 2
fi
...
then
    ...
    buildHist Ablector_Mul/all/2019-06-26T15:59+02:00 MulNode 2
fi
...
then
    ...
    buildHist Ablector_Mul/segment_aa/2019-06-30T09:57+02:00 MulNode 2
fi
...
then
    ...
    buildHist Ablector_Mul/all/2019-07-05T11:45+02:00 MulNode 2
fi
...
then
    compare ablector Ablector_Mul/all/2019-07-05T16:17+02:00 2 boolector Boolector_SoA/all/2019-06-26T15:59+02:00 1 real time satpart
    buildHist Ablector_Mul/all/2019-07-05T16:17+02:00 MulNode 2
    buildHist Ablector_Mul/all/2019-07-05T16:17+02:00 SdivNode 2
fi

if newDir results/mul-vs-sdiv-mul
then
    compare sdiv-mul Ablector_Mul/all/2019-07-05T16:17+02:00 2 mul Ablector_Mul/all/2019-07-05T11:45+02:00 2 real time satpart
fi
